...
{  
    ...
    void AlongWall::bumpScan()
    {
        ...
        //回充座虚拟墙
        else if(!isVirEmpty && !isInVirArea && WallFallowPara.State == WallFollowAlong && WallFallowPara.Dir == RIGHTAW 
        ...
        else if(!isVirEmpty && !isInVirArea && WallFallowPara.State == WallFollowAlong && WallFallowPara.Dir == LEFTAW 
        ...
        else if(!isVirEmpty && !isInVirArea && WallFallowPara.State == WallFollowForbid && WallFallowPara.Dir == RIGHTAW 
        ...
        else if(!isVirEmpty && !isInVirArea && WallFallowPara.State == WallFollowForbid && WallFallowPara.Dir == LEFTAW 
        ...
        //禁区
        else if(!isForEmpty && !WallFallowPara.RestrictedZone && WallFallowPara.Dir == RIGHTAW 
        ...
        else if(!isForEmpty && !WallFallowPara.RestrictedZone && WallFallowPara.Dir == LEFTAW 
         ...
         || WallFallowPara.BumpState == RadarFront || WallFallowPara.BumpState == RadarLeft || WallFallowPara.BumpState == RadarRight)
        {
            ...
            // {               
                ...
                if(WallFallowPara.BumpState == RadarFront && WallFallowPara.Dir == RIGHTAW \
                    && (currentSensor.wallData.rightWallDistance < 180))          
                {      
        ...
        else if(FAST_QUICK == WallFallowPara.Speed)
        {
        ...
        {
            if(pidCount ++ >= 4000 / 20 && currentSensor.leftw > 100 && currentSensor.rightw > 100 && abs(currentSensor.leftw - currentSensor.rightw) < 120 && WallFallowPara.RestrictedZone == 0)
            {
                pidCount = 4000 / 20;
        ...
        switch(WallFallowPara.BumpDealState)
        {
            ...
            case Turn:
            {
                if(WallFallowPara.BumpRecord == IntoVir)
                {
                    ...
                    //     rotateFlag = 1;
                    // }
                    // if(!rotaterobot(recordForward, virRotateAngle))
                ...
                else if(WallFallowPara.BumpRecord == ForbidFront)
                {
                    if(!rotateFlag)
                    {
                        // chassis.GridPoint(&current_pos);
        ...
        // {
            ...
            switch (WallFallowPara.State)
            {
                ...
                case WallFollowAlong:
                    ...
                    //     {
                    //         chassis.chassisSpeed(WALL_SPEED, WALL_SPEED * 0.05, 1);
                    //     }
                    //     else
                    //     {
                    //         chassis.chassisSpeed(WALL_SPEED, WALL_SPEED * 0.3, 1);
                    //     }
                    //     recognizeSmallPlace();  
                    //     break;
                    // }
                    ...
                    //     else if(smallPlaceFlag)
                    //     {
                    //         chassis.chassisSpeed(WALL_SPEED * 0.05, WALL_SPEED, 1);
                    //     }
                    //     else
                    //     {
                    //         chassis.chassisSpeed(WALL_SPEED * 0.3, WALL_SPEED, 1);
                    //     }
                    //     recognizeSmallPlace();
                    //     break;
                    // }
                    ...
                    // {
                    //     chassis.chassisSpeed(wallLeftWheel, wallRightWheel, 1);
                    //     FRIZY_LOG(LOG_DEBUG,"LEFTAW send pid wall speed finished:%d, %d", ((WALL_SPEED - (CinDSpeed / 2)) >= 0 ? (WALL_SPEED - (CinDSpeed / 2)) : 1),  WALL_SPEED + (CinDSpeed / 2));
                    // }
                    // else if(WallFallowPara.Dir == RIGHTAW)//右沿墙
                    // {
                    //     chassis.chassisSpeed(wallLeftWheel, wallRightWheel, 1);
                    //     FRIZY_LOG(LOG_DEBUG,"RIGHTAW send pid wall speed finished:%d, %d", WALL_SPEED + (CinDSpeed / 2), ((WALL_SPEED - (CinDSpeed / 2)) >= 0 ? (WALL_SPEED - (CinDSpeed / 2)) : 1));
                    // }
                    recognizeSmallPlace();   
